...
VkExtent2D VulkanRenderer::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, int width, int height)
{
...
void VulkanRenderer::DrawFrame()
{
	...
	{
		throw std::runtime_error("Failed to sumbit draw command buffer!");
	}
...
void VulkanRenderer::CreateDescriptorSetLayout()
{
	...
	{
		throw std::runtime_error("Failed to create desciptor set layout!");
	}
}
